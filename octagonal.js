...
function doFirst(){
    ...
    context.lineTo(590, 160);  
    context.lineTo(570, 290); 
    context.lineTo(710, 260); 
    context.lineTo(590, 360); 
    context.lineTo(710, 440); 
    context.lineTo(550, 430); 
    context.lineTo(590, 560); 
    ...
    context.lineTo(710, 260);
    context.lineTo(590, 360); 
    context.lineTo(730, 440); 
    context.lineTo(570, 430); 
    context.lineTo(610, 560); 
    ...
    context.lineTo(410, 550);
    context.lineTo(510, 450);
